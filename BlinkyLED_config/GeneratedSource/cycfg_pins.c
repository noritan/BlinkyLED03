...
const cy_stc_gpio_pin_config_t CONSOLE_RX_config = 
{
	.outVal = 1,
	.driveMode = CY_GPIO_DM_PULLUP,
	.hsiom = CONSOLE_RX_HSIOM,
	.intEdge = CY_GPIO_INTR_DISABLE,
	.intMask = 0UL,
	.vtrip = CY_GPIO_VTRIP_CMOS,
	.slewRate = CY_GPIO_SLEW_FAST,
...
const cy_stc_gpio_pin_config_t CONSOLE_TX_config = 
{
	.outVal = 1,
	.driveMode = CY_GPIO_DM_STRONG_IN_OFF,
	.hsiom = CONSOLE_TX_HSIOM,
	.intEdge = CY_GPIO_INTR_DISABLE,
	.intMask = 0UL,
	.vtrip = CY_GPIO_VTRIP_CMOS,
	.slewRate = CY_GPIO_SLEW_FAST,
...
void init_cycfg_pins(void)
{
	...
	Cy_GPIO_Pin_Init(CONSOLE_RX_PORT, CONSOLE_RX_PIN, &CONSOLE_RX_config);

	Cy_GPIO_Pin_Init(CONSOLE_TX_PORT, CONSOLE_TX_PIN, &CONSOLE_TX_config);
